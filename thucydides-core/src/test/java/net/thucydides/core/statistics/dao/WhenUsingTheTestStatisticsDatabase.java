...
public class WhenUsingTheTestStatisticsDatabase {
    ...
    @Test
    public void should_be_able_to_define_statistics_database_via_DataNucleus_system_properties() {
        ...
        assertThat((String)properties.get("datanucleus.connectiondrivername"), is("org.hsqldb.jdbc.JDBCDriver"));
        assertThat((String)properties.get("datanucleus.connectionurl"), is("jdbc:hsqldb:mem:test"));
        assertThat((String)properties.get("datanucleus.connectionusername"), is("admin"));
        assertThat((String)properties.get("datanucleus.connectionpassword"), is("password"));
        assertThat((String)properties.get("thucydides.jpa.provider"), is(JPAProvider.DataNucleus.name()));
